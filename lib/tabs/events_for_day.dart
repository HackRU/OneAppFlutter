...
class _EventCardState extends State<EventCard> {
  ...
  Widget build(BuildContext context) {
    var time = widget.resource.start.toLocal().toString().substring(11, 16);
    var date = widget.resource.start.toLocal().toString().substring(8, 10);
              ...
              children: <Widget>[
                new Container(
                  ...
                  child: PinchZoomImage(
                    image: Image.asset('assets/images/map/' +
