...
const FLOOR_MAP_HOR = "https://hackru-misc.s3-us-west-2.amazonaws.com/floormap_horziontal.png";
const FLOOR_MAP_VER = "https://hackru-misc.s3-us-west-2.amazonaws.com/floormap_vertical.png";
...
const kAboutHackRU = "HackRU is a 24-hour hackathon at Rutgers University. We welcome hundreds of students to join us in building awesome tech projects. Industry experts and mentors help foster an atmosphere of learning through tech-talks and one-on-one guidance. We encourage all students, no matter their experience level or educational background, to challenge themselves and expand their creative, technical, and collaboration skills at HackRU.";
const kAboutApp = "The HackRU App is an open source effort made possible by the HackRU Research & Development Team. Hackers would be able to get announcements, a QR code for checking, food, etc. as well as see the schedule and map for the hackathon. Organizers would have an access to the QR Scanner.";
